...
exports.commands = {
	profile: function(target, room, user) {
		...
		function showProfile() {
			...
			if (!getFlag(toId(username))) profile += '&nbsp;<font color="black"><b>Name:</b></font> <b><font color="' + hashColor(toId(username)) + '">' + Tools.escapeHTML(username) + '</font></b><br />';
			if (getFlag(toId(username))) profile += '&nbsp;<font color="black"><b>Name:</b></font> <b><font color="' + hashColor(toId(username)) + '">' + Tools.escapeHTML(username) + '</font></b>' + getFlag(toId(username)) + '<br />';
			profile += '&nbsp;<font color="black"><b>Registered:</b></font> ' + regdate + '<br />';
			if (!Users.vips[userid]) profile += '&nbsp;<font color="black"><b>Rank: </font></b>' + userGroup + '<br />';
			if (Users.vips[userid]) profile += '&nbsp;<font color="black"><b>Rank: </font></b>' + userGroup + ' (<font color=#800000><b>Inferno DEV</b></font>)<br />';
			if (online) profile += '&nbsp;<font color=""><b>Status: </font></b><font color=green>Currently Online</font><br />';
			if (!online) profile += '&nbsp;<font color="black"><b>Status: </font></b><font color=red><b>OFFLINE</b><br />';
